...
namespace discordpp{
	...
	public:
		...
		virtual void call(std::string requestType, std::string targetURL, json body, std::function<void(json)> callback) = 0;
	...
	protected:
		...
		virtual void ratelimited(bool global, unsigned long long retryAfter, std::string requestType, std::string targetURL, json body) = 0;

		virtual json doCall(std::string requestType, std::string targetURL, json body = {}) = 0;
		...
		virtual std::string getBucket(std::string toBucket){
